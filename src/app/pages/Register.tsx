...
export function Register() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4">
      ...
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_70%_80%,rgba(200,181,154,0.28),transparent_42%),radial-gradient(circle_at_18%_20%,rgba(107,111,122,0.12),transparent_24%)] dark:bg-[radial-gradient(circle_at_70%_80%,rgba(200,181,154,0.14),transparent_34%),radial-gradient(circle_at_18%_20%,rgba(107,111,122,0.1),transparent_22%)]" />
